<template>
  <div class="min-h-screen bg-purple-50">
    <UContainer class="max-w-6xl mx-auto py-12">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900">Applications received</h1>
        <p class="text-gray-500 mt-2 text-lg">Manage all applications for your posted jobs.</p>
      </div>
          ...
          <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div class="flex items-start justify-between gap-4">
              ...
              <div class="text-right">
                ...
                <div class="text-3xl font-bold text-blue-600">{{ job.applications.length }}</div>
              </div>
            </div>
          </div>
